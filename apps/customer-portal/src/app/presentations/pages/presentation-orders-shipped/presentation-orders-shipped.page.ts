...
@UntilDestroy()
@Component({
  selector: 'esp-presentation-orders-shipped',
  templateUrl: './presentation-orders-shipped.page.html',
  styleUrls: ['./presentation-orders-shipped.page.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PresentationOrdersShippedPage {
...
@NgModule({
  declarations: [PresentationOrdersShippedPage],
  imports: [
    CommonModule,
...
export class PresentationOrdersShippedPageModule {}
