...
@Component({
  selector: 'esp-presentation-quote-sent',
  templateUrl: './presentation-quote-sent.page.html',
  styleUrls: ['./presentation-quote-sent.page.scss'],
})
export class PresentationQuoteSentPage {}

@NgModule({
  declarations: [PresentationQuoteSentPage],
  imports: [
    CommonModule,
...
export class PresentationQuoteSentPageModule {}
